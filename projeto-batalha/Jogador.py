...
class Jogador:
    ...
    def elements_in_stack(self):
        # Pecorre todos os nós do deck exibindo os seus determinados valores
        head = self.__head
        string = "topo -> ["
        first = True
    ...
    def __str__(self):
        # retorna uma string com o nome do jogador e a quantidade de cartas
        return f"Jogador {self.__name}, tem {self.__length} cartas\n"
